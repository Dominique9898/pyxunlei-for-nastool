...
if __name__ == "__main__":
    try:
        ...
        # xunlei_client.pause_task('VOEhg_FC1AOv9YzMqC95nUvzA1')

        # xunlei_client.start_task('VOEhg_FC1AOv9YzMqC95nUvzA1')

        xunlei_client.delete_task('VOEhg_FC1AOv9YzMqC95nUvzA1')
